...
COPY ["src/Modules/Shop.Module.Schedule/Shop.Module.Schedule.csproj", "src/Modules/Shop.Module.Schedule/"]
...
COPY ["src/Modules/Shop.Module.StorageSm/Shop.Module.StorageSm.csproj", "src/Modules/Shop.Module.StorageSm/"]
