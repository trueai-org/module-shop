        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "MiniProgramOptions", 1, true, "MiniProgram", null, "Shop.Module.Core.MiniProgram.Models.MiniProgramOptions, Shop.Module.Core.MiniProgram, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "{\"AppId\":\"wxc90c1e6038d9960b\",\"AppSecret\":\"736192139a4ca393de4a18ce22eadb5a\",\"MchId\":\"1526185231\",\"Key\":\"jtA9J79YNUXnTRpVntHqTGSF2h8XmFhy\"}" },
                    { "HangfireOptions", 1, true, "Hangfire", null, "Shop.Module.Hangfire.Models.HangfireOptions, Shop.Module.Hangfire, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "{\"Provider\":0,\"MySqlHangfireConnection\":\"server=cdb-29stmsyr.gz.tencentcdb.com;PORT=10012;database=shop_hangfire;uid=root;pwd=czYj9hnFaVUfZgm7;Connection Timeout=60;Allow Zero Datetime=True;Allow User Variables=True;pooling=true;min pool size=5;max pool size=512;SslMode=None;\",\"SqlServerHangfireConnection\":\"Data Source=circle.ac.cn;Initial Catalog=ShopTest;User ID=sa;Password=fQs2Uba_y3kWS,uC\",\"RedisHangfireConnection\":\"circle.ac.cn:16379,password=gBbvank9XfZ3A%SK,allowadmin=true\",\"Username\":\"admin\",\"Password\":\"123456\"}" },
                    ...
                    { "SmsSenderAliyunOptions", 1, true, "SmsSenderAliyun", null, "Shop.Module.SmsSenderAliyun.Models.SmsSenderAliyunOptions, Shop.Module.SmsSenderAliyun, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "{\"RegionId\":\"default\",\"AccessKeyId\":\"LTAI8v8Crrypk7mr\",\"AccessKeySecret\":\"BVZY9tPKjNsuAg2njEgZa1KI9dCj9m\",\"IsTest\":true}" },
                    { "EmailSenderSmtpOptions", 1, true, "EmailSenderSmtp", null, "Shop.Module.EmailSenderSmtp.EmailSenderSmtpOptions, Shop.Module.EmailSenderSmtp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "{\"SmtpUserName\":\"system@trueai.org\",\"SmtpPassword\":\"eQga*GDkF^PAV2Ep\",\"SmtpHost\":\"smtp.mxhichina.com\",\"SmtpPort\":587}" },
                    { "ShopConfig", 1, true, "Core", null, "Shop.Infrastructure.ShopConfig, Shop.Infrastructure, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "{\"ShopName\":\"天网商城\",\"CacheTimeInMinutes\":60,\"RedisCachingEnabled\":true,\"RedisCachingConnection\":\"circle.ac.cn:16379,ssl=False,password=gBbvank9XfZ3A%SK,allowadmin=true\"}" },
                    { "WebHost", 0, true, "Core", null, null, "http://localhost:8000/" },
                    { "ApiHost", 0, true, "Core", null, null, "https://localhost:44372/" },
